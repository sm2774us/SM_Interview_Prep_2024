...
public class ChocolatesByNumbersTest {
	...
	private static Logger LOG = LoggerFactory.getLogger(ChocolatesByNumbersTest.class);

	static ChocolatesByNumbers chocolatesByNumbers;
    ...
    public void solutionTest() {
		final int N = 10;
		final int M = 4;
		final int result = chocolatesByNumbers.solution(N, M);
