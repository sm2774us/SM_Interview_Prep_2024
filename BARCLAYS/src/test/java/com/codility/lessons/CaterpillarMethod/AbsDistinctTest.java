...
public class AbsDistinctTest {
	...
	private static Logger LOG = LoggerFactory.getLogger(AbsDistinctTest.class);

	static AbsDistinct absDistinct;
	...
	public void solutionTest_1() {
		...
		final int result = absDistinct.solution1(A);
	...
	public void solutionTest_2() {
		final int[] A = {-5, -3, -1, 0, 3, 6};
		final int result = absDistinct.solution2(A);
		assertThat(result).isEqualTo(5);
