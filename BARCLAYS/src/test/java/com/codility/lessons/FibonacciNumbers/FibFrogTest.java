...
public class FibFrogTest {
	...
	private static Logger LOG = LoggerFactory.getLogger(FibFrogTest.class);

	static FibFrog fibFrog;
	...
	public void solutionTest_1() {
		...
		final int result = fibFrog.solution1(A);
	...
	public void solutionTest_2() {
		final int[] A = {0, 0, 0, 1, 1, 0, 1, 0, 0, 0, 0};
		final int result = fibFrog.solution2(A);
		assertThat(result).isEqualTo(3);
    }
